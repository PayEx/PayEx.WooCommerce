 ...
 *
 */
class WC_Order_Compatibility_Payex {
	...
	public static function order_class( $classname, $post_type, $order_id, $the_order ) {
		...
		if ( empty( $payment_method ) || strpos($payment_method, 'payex') === false ) {
			return $classname;
		}
...
add_filter( 'woocommerce_order_class', 'WC_Order_Compatibility_Payex::order_class', 10, 4 );
