...
class WC_Tests_Payment_Bankdebit extends WC_Payment_Unit_Test_Case {
	/**
	...
	/**
	 * @var WC_Gateway_Payex_Bankdebit
	 */
	private $gateway;
	...
	public function setUp() {
		...
		// Init PayEx Payments plugin
		$this->gateway              = new WC_Gateway_Payex_Bankdebit();
	...
	public function test_wc_payment() {
		...
		$this->assertInstanceOf( 'WC_Gateway_Payex_Bankdebit', $payment_gateways[ self::METHOD ] );
	}
