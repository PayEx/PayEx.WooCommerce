...
class WC_Tests_Payment_MasterPass extends WC_Payment_Unit_Test_Case {
	/**
	...
	/**
	 * @var WC_Gateway_Payex_MasterPass
	 */
	private $gateway;
	...
	public function setUp() {
		...
		// Init PayEx Payments plugin
		$this->gateway              = new WC_Gateway_Payex_MasterPass();
	...
	public function test_wc_payment() {
		...
		$this->assertInstanceOf( 'WC_Gateway_Payex_MasterPass', $payment_gateways[ self::METHOD ] );
	}
