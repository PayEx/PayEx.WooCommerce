...
class Px {
	...
	protected static $_rules = [
		...
		'PxOrderWSDL'        => [
			...
			'GetApprovedDeliveryAddress',
			'GetLowestMonthlyInvoiceSaleAmount',
			...
			'PrepareSaleDD2',
			'PurchaseActivate',
			'PurchaseFinancingInvoice',
			'PurchaseInvoiceCorporate',
			'PurchaseInvoicePrivate',
			'PurchaseInvoiceSale',
			'PurchasePartPaymentSale',
			'PurchaseOTT',
			'PurchaseInvoicePartPaymentSale',
			'PurchasePX',
			'SaleEVC',
			'SaleInvoiceLedger',
			'SaleGC',
			'PurchaseWyWallet',
			'PreparePurchaseWyWallet',
			'PurchaseCreditAccount'
		],
		/** @see http://www.payexpim.com/category/pxverification/ */
		'PxVerificationWSDL' => [
			'CreditCheckCorporate2',
			'CreditCheckPrivate2',
			'GetConsumerLegalAddress',
			'NameCheckPrivate'
		],
